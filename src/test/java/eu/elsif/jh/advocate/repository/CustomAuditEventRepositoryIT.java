package eu.elsif.jh.advocate.repository;

import eu.elsif.jh.advocate.AdvocateApp;
import eu.elsif.jh.advocate.config.Constants;
import eu.elsif.jh.advocate.config.audit.AuditEventConverter;
import eu.elsif.jh.advocate.domain.PersistentAuditEvent;
...
import static eu.elsif.jh.advocate.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
